...
screen navigation():
    ...
    hbox:
        ...
        if main_menu:
            ...
            textbutton _("INITIUM") action Start()

        else:

            textbutton _("HISTORIA") action ShowMenu("history")

            textbutton _("SERVO") action ShowMenu("save")

        textbutton _("PONDUS") action ShowMenu("load")

        textbutton _("OPTIO") action ShowMenu("preferences")
        ...
        if _in_replay:
            ...
            textbutton _("DOMUM") action MainMenu()

        textbutton _("CIRCA") action ShowMenu("about")

        if renpy.variant("pc"):

            ## The quit button is banned on iOS and unnecessary on Android and
            ## Web.
            textbutton _("LIBER") action Quit(confirm=not main_menu)
...
screen main_menu():
    ...
    use navigation
    add "gui/logo.png" xalign 0.5 yalign 0.0
    if gui.show_name:
